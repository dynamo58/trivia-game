...
const ws_handler: HandlerFunc = async (c) => {
	...
	const { conn, headers, r: bufReader, w: bufWriter } = c.request;
  	...
  	for await (const e of ws) {
		...
		// TODO: I have no idea what this is supposed to look like
		// [no runtime access], so I'm just gonna leave something out for now
